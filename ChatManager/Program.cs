...
internal class Program
{
    ...
    private static async Task Main(string[] args)
    {
        ...
        bot = new TelegramBotClient("7558769675:AAFC_k3EIeaL2FxdpEHQN9mvPhqVQarolEM", cancellationToken: cts.Token);
    ...
    {
        if (update.Type != UpdateType.CallbackQuery || update.CallbackQuery == null) return;
